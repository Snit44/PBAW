...
define('_ROOT_PATH', dirname(__FILE__)); // корень проекта
...
define('_SMARTY_PATH', _ROOT_PATH . '/smarty'); // Путь к папке Smarty
define('_CORE_PATH', _ROOT_PATH . '/core');
define('_ASSETS_PATH', _ROOT_PATH . '/assets');

// Функция для вывода значений с проверкой на наличие
function out(&$param) {
    if (isset($param)) {
        echo $param;
    }
