    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right">
                ...
                <li><a class="btn" href="{$smarty.const._APP_URL}/index.php?action=logout">Wyloguj</a></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="calculator-section">
        ...
        <form action="{$smarty.const._APP_URL}/index.php?action=calcCompute" method="post" class="form-horizontal mt-4">
            <div class="form-group">
                ...
                <input id="id_amount" type="text" name="amount" value="{$form->amount|default:''}" class="form-control form-control-smaller" placeholder="Wprowadź kwotę" />
            </div>
            <div class="form-group">
                <label for="id_years" class="control-label">Okres kredytowania (lata):</label>
                <input id="id_years" type="text" name="years" value="{$form->years|default:''}" class="form-control form-control-smaller" placeholder="Wprowadź lata" />
            </div>
            <div class="form-group">
                <label for="id_interest" class="control-label">Oprocentowanie (% rocznie):</label>
                <input id="id_interest" type="text" name="interest" value="{$form->interest|default:''}" class="form-control form-control-smaller" placeholder="Wprowadź oprocentowanie" />
            </div>
